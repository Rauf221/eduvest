        ...
        <Container className="flex items-center justify-between py-7">
          ...
          >
            <span
              ...
              style={{ height: '1.5px', transition: 'transform 0.3s', transform: open ? 'translateY(6.5px) rotate(45deg)' : 'none' }}
            />
            <span
              className="block w-6 bg-white"
              style={{ height: '1.5px', transition: 'opacity 0.3s', opacity: open ? 0 : 1 }}
            />
            <span
              className="block w-6 bg-white"
              style={{ height: '1.5px', transition: 'transform 0.3s', transform: open ? 'translateY(-6.5px) rotate(-45deg)' : 'none' }}
